  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundColor: "#a02a2f", // Wine color as fallback
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                to simplify the property search process while maintaining the
                human connection that is essential to finding the perfect home.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-sm text-center">
                ...
                <p className="text-gray-600">
                  We partner with professional, vetted agents who are committed
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
                  ...
                  <p className="text-gray-700 mb-6">
                    ...
                    thousands of users across the country, helping them find
                    their dream homes and make informed real estate decisions.
                  </p>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-gray-600">
                          Expanded to serve three major cities with 500+
                          listings
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="relative h-80 md:h-96 overflow-hidden rounded-lg shadow-lg bg-gray-200">
                    <Image
                      ...
                      onError={(e) => {
                        ...
                        e.target.src = "/images/placeholder-property.svg";
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-700 max-w-2xl mx-auto">
                Meet the dedicated professionals who are working to
