...
/**
 * Create a standardized API response (generic handler)
 * @param {Object} res - Express response object
 * @param {Number} status - HTTP status code
 * @param {Object|null} data - Response data payload (null for errors)
 * @param {String} message - Response message
 * @returns {Object} - The response object
 */
export function apiResponse(res, status = 200, data = null, message = "") {
